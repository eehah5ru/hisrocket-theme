...
if ($zenpage && !isArchive()) {
	$numpages = getNumPages(); if ($numpages > $hrlfh_zpsearchcount) $numpages = $hrlfh_zpsearchcount;
	$numnews = getNumNews(); if ($numnews > $hrlfh_zpsearchcount) $numnews = $hrlfh_zpsearchcount;
				...
				<div id="main"<?php if ($hrlfh_switch) echo ' class="switch"'; ?>>
					...
					<div id="thumbs-wrap">
						...
						<div class="thumb-maxspace">
							...
							<?php if (($hrlfh_colorbox) && ($cb) && (!isImageVideo())) { ?>
							<div class="cblinks">
					...
					if ($numpages > 0) {
					$zpc = 0;
					while (($zpc < $hrlfh_zpsearchcount) && (next_page())) {
						$zpc++; $c++; ?>
					...
					if ($numnews > 0) {
					$zpc = 0;
					while (($zpc < $hrlfh_zpsearchcount) && (next_news())) {
						$zpc++; $c++; ?>
						<div class="news-truncate"> 
